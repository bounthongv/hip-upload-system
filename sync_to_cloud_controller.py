...
class ServiceController:
    ...
    def start_service():
        try:
            win32serviceutil.StartService("HIPSyncToCloud")
    ...
    def stop_service():
        try:
            win32serviceutil.StopService("HIPSyncToCloud")
    ...
    def restart_service():
        try:
            win32serviceutil.RestartService("HIPSyncToCloud")
    ...
    def service_status():
        try:
            status = win32serviceutil.QueryServiceStatus("HIPSyncToCloud")[1]
            status_map = {
...
class SystemTrayApp:
    def __init__(self):
        ...
        # Create a temporary icon since we don't have a specific one
    ...
    def show_about(self):
        ...
        msg.setWindowTitle("About HIP Sync Controller")
