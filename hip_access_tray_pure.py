"""
System Tray Application for HIP Access to Cloud Sync (Pure Python Mode)
Uses access-parser to avoid ODBC driver issues.
"""
import sys
import os
import ctypes
...
# Import the PURE manager logic
try:
    from access_sync_manager_pure import PureAccessSyncManager as AccessSyncManager
except ImportError:
...
class SyncWorker(QThread):
    ...
    def run(self):
        ...
        self.log_signal.emit("Worker thread started (Pure Python Mode). Waiting for schedule...")
...
class ConfigDialog(QDialog):
    ...
    def __init__(self, manager):
        ...
        self.setWindowTitle("Configuration Editor (Pure Mode)")
